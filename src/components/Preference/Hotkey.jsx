...
function PreferenceHotkey() {
    ...
    async function setSearchHotKeyValue(newStatus) {
        try {
            ...
            toast.success('Search hotkey updated successfully. Please restart the app to see the changes.');
        } catch (error) {
            console.log(error);
            toast.error('Failed to update search hotkey. Please reach out to us using the chat widget.');
        }
    }
    ...
    return (
        <Card className="mt-8">
            <CardHeader>
                <CardTitle>
                    <div className="flex items-center justify-between">Keyboard Shortcuts</div>
                </CardTitle>
            </CardHeader>
            <CardContent>
                <div className="mb-8 flex">
                    <div>
                        ...
                        <CardDescription>Manage the keyboard shortcut to open the Infr Searchbar.</CardDescription>
                    </div>
                    <div className="ml-auto flex">
                        ...
                        />
                        <Button className="ml-2" onClick={setSearchHotKeyValue}>
                            Save
                        </Button>
                    </div>
                </div>
